{
  description = "A flake for building latest Azure CLI. Mostly pulled from: https://github.com/NixOS/pkgs-unstable/tree/nixos-unstable/pkgs/tools/admin/azure-cli";
    ...
    defaultPackage.aarch64-darwin =
      let
        ...
        src = pkgs.fetchFromGitHub {
          ...
          sha256 = "sha256-ujt6N3UpH0j/bGMFJfTiT6ycxHLkqyiddQ1BWBgcAE0=";
        };
      ...
      py.pkgs.toPythonApplication
        (py.pkgs.buildAzureCliPackage {
          ...
          meta = with pkgs.lib; {
            ...
            maintainers = with maintainers; [ jonringer phantlantis ];
          };
